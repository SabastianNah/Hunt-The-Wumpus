...
class Wumpus {
	public:
		Wumpus();
		// Set inital wumpusTiredness
		void setwumpusTiredness(int);
		// Randomizes Wumpus placement
		void setWumpus(int, int);
		// Display Wumpus' room
		void printWumpus();
		// Check if near Wumpus room
		bool nearWumpus(int);
		// Check if currently in Wumpus Room
		bool isWumpus(int);
	private:
		friend class Cave;
		int wumpusTiredness;
